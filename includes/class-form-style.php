...
final class Form_Style {
	...
	private static function builtin_named_schemes(): array {
		/*
		 * Each role uses a distinct hex within a scheme (no repeated swatches).
		 * Light schemes: Surface / Input are soft fills; Button text stays pure white for contrast.
		 */
		return array(
			'formkit'       => array(
