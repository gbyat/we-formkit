		...
		wp_localize_script(
			...
			array(
				...
				'i18n'              => array(
					...
					'matrixHint'                => __( 'Add preset rows and/or allow visitor-added rows. With no presets, an inactive example row shows the grid until visitors add their own.', 'we-formkit' ),
					'matrixMinAnsweredRows'     => __( 'Minimum answered rows', 'we-formkit' ),
					'matrixMinAnsweredRowsHint' => __( '0 = optional. Replaces the generic Required toggle for this field.', 'we-formkit' ),
					'matrixColRequiredHint'     => __( 'Only when the row is selected or filled.', 'we-formkit' ),
					'matrixRowsSelfFillHint'    => __( 'No preset rows — visitors add their own (self-fill). Per-row Required applies only to catalog rows you add below.', 'we-formkit' ),
