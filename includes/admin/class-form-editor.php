		...
		wp_localize_script(
			...
			array(
				...
				'i18n'              => array(
					...
					'radioImageDisplayHint'          => __( 'Image size uses WordPress media sizes (not full resolution). Columns apply from tablet width up; phones stay single-column.', 'we-formkit' ),
