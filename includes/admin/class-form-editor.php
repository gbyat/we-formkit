		...
		wp_localize_script(
			...
			array(
				...
				'i18n'              => array(
					...
					'matrixAllowCustomRowsHint' => __( 'Replaces a static “Other” row: visitors type their own label and answer the same columns.', 'we-formkit' ),
					...
					'matrixColSampleRadio'      => __( 'Choice', 'we-formkit' ),
					'matrixColSampleCheck'      => __( 'Flag', 'we-formkit' ),
					...
					'allowOther'                => __( 'Allow “Other” with free text', 'we-formkit' ),
					'allowOtherHint'            => __( 'Visitors can tick Other and type their own answer. Typing auto-checks Other. (Not available for radio fields.)', 'we-formkit' ),
					'otherLabel'                => __( 'Other label', 'we-formkit' ),
					'otherLabelDefault'         => __( 'Other', 'we-formkit' ),
