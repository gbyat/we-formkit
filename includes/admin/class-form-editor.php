		...
		wp_localize_script(
			...
			array(
				...
				'i18n'              => array(
					...
					'consentDefaultLabel'       => __( 'I agree to the {link}', 'we-formkit' ),
					'consentLinkHint'           => __( 'Put {link} in the label where the linked text should appear. Without {link}, no link is shown.', 'we-formkit' ),
					...
					'allowOther'                => __( 'Allow “Other”', 'we-formkit' ),
