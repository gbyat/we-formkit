		...
		wp_localize_script(
			...
			array(
				...
				'i18n'              => array(
					...
					'repeaterHint'        => __( 'Add fields on the canvas (drag into the repeater). Min/max control how many rows visitors can add.', 'we-formkit' ),
					...
					'repeaterEmpty'       => __( 'No fields yet. Drag fields here or use Add field.', 'we-formkit' ),
